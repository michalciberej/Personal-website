...
const Contact = () => {
  return (
    <>
      <div className='md:container md:mx-auto bg-primary rounded-xl py-8 px-12 mx-12 flex flex-col md:flex-row items-center justify-around shadow-[0px_5px_5px_1px_rgba(0,0,0,0.35)] md:-mb-16 -mb-44 z-10 gap-6 md:gap-0'>
